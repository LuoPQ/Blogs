; (function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        "btnPrevSelector": ".btnPrev",
        "btnNextSelector": ".btnNext",
        "indexClass": null,
        "bindHover": true,
        "onInit": null,
        "onBeforeChange": null,
    ...
    Slider.prototype = {
        ...
        bindEvent: function () {
            ...
            var $btnPrev = $(that.options.btnPrevSelector);
            var $btnRight = $(that.options.btnNextSelector);
            $btnPrev.exist() && $btnPrev.on("click", function () {
