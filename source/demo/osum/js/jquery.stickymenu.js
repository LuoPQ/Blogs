; (function ($, window, document, undefined) {
    ...
    StickyMenu.prototype = {
        ...
        getMenuItems: function () {
            ...
            // 菜单链接
            var $links = this.$menu.find(this.options.linkSelector + ":not(.exceptLink)");
        ...
        bindEvent: function () {
            ...
            this.$menu.on("click", options.linkSelector + ":not(.exceptLink)", function () {
                var index = $(this).index();
                menuItems[index] && menuItems[index].scrollToSection(options.speed, options.onLinkSelected);
            })
